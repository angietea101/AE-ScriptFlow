        ...
        function myScriptBuildUI(thisObj) {
            var myPanel =
                thisObj instanceof Panel
                    ? thisObj
                    : new Window("palette", "Dockable Script", undefined, {
                          resizeable: true,
                          closeButton: false,
                      });
            ...
            myPanel.grp.groupSix.deleteFreezeFramesButton.onClick =
                function () {
                    deleteFreezeFrames();
                };

            myPanel.grp.groupSeven.deleteFreezeFramesButton2.onClick =
                function () {
                    deleteFreezeFrames2();
                };
...
// File Paths
var watermarkPath =
    "C:/Users/Angie/Documents/Adobe/After Effects 2023/User Presets/Watermark.ffx";
var coloringPath =
